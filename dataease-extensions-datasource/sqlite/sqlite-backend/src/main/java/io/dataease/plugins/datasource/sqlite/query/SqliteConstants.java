...
public class SqliteConstants extends SQLConstants {
    ...
    public static final String UNIX_TIMESTAMP = "STRFTIME('%%s', %s)";

    public static final String DATE_FORMAT = "STRFTIME('%s',%s)";
    public static final String STR_TO_DATE = "STRFTIME('%s',%s)";
    public static final String DEFAULT_DATE_FORMAT = "%Y-%m-%d %H:%M:%S";
    public static final String FROM_UNIXTIME = "STRFTIME('%s',datetime(%s, 'unixepoch'))";
